...
![结构图](https://s2.loli.net/2024/04/28/CI8P2Oico4z3dfx.png)

![层级描述](https://s2.loli.net/2024/04/28/sRPwOM4KB6AFNpm.png)
...
![InnoDB逻辑存储结构](https://s2.loli.net/2024/04/28/Pg5q7jfQ6YhrOcW.png)
...
![二叉树](https://s2.loli.net/2024/04/28/RimxhIwCQ6GNO9Z.png)

二叉树形成链表的缺点可以用红黑树来解决：
![红黑树](https://s2.loli.net/2024/04/28/STB58ZdoENun7mJ.png)
红黑树也存在大数据量情况下，层级较深，检索速度慢的问题。

为了解决上述问题，可以使用 B-Tree 结构。
B-Tree (多路平衡查找树) 以一棵最大度数（max-degree，指一个节点的子节点个数）为5（5阶）的 b-tree 为例（每个节点最多存储4个key，5个指针）

![B-Tree结构](https://s2.loli.net/2024/04/28/IxmRKfviVp4AqwC.png)
...
![B+Tree结构图](https://s2.loli.net/2024/04/28/pyHcseml4VLgUbx.png)
...
![MySQL B+Tree 结构图](https://s2.loli.net/2024/04/28/5V1y4cAXCQax3dZ.png)
...
![Hash索引原理图](https://s2.loli.net/2024/04/28/f3LXlZ5eocFwHNU.png)
...
![大致原理](https://s2.loli.net/2024/04/28/FPpkRILTaqNv9U6.png)![演示图](https://s2.loli.net/2024/04/28/9dRgBsowvKrGxWh.png)
...
![pre](https://s2.loli.net/2024/04/28/FZxdjtsfVim8zMS.png)
...
![uion](https://s2.loli.net/2024/04/28/AxdZpRN7gGv6XnS.png)
...
![keySort](https://s2.loli.net/2024/04/28/V3Pzm91vBoYWaD7.png)
...
![artic](https://s2.loli.net/2024/04/28/xrVMmG2EDj5vpkQ.png)

Buffer Pool：缓冲池是主内存中的一个区域，里面可以缓存磁盘上经常操作的真实数据，在执行增删改查操作时，先操作缓冲池中的数据（若缓冲池没有数据，则从磁盘加载并缓存），然后再以一定频率刷新到磁盘，从而减少磁盘I0，加快处理速度。

![artic2](https://s2.loli.net/2024/04/28/zxftaVUj1BechZN.png)
![artic3](https://s2.loli.net/2024/04/28/BXCZs8JHbgOTK4t.png)
![artic4](https://s2.loli.net/2024/04/28/ChpcdPFarBluwLU.png)

![artic5](https://s2.loli.net/2024/04/28/4Da9NPIWMHdUhei.png)

磁盘架构：
![artic6](https://s2.loli.net/2024/04/28/T1FQZAU4LauRBYv.png)![artic7](https://s2.loli.net/2024/04/28/fPlI1DiOj4ktcKB.png)

![artic8](https://s2.loli.net/2024/04/28/xTYKLAamsEdke8M.png)
...
![MVCC](https://s2.loli.net/2024/04/28/iEmOdlH41WZ6Gfq.png)
...
![MVCCList](https://s2.loli.net/2024/04/28/ZF5Q2djatYOgqEb.png)

如何确定返回哪一个版本 这是由read view决定返回 undo log 中的哪一个版本。

![readview0](https://s2.loli.net/2024/04/28/fAoc4TYHBOdKrye.png)
...
![readview](https://s2.loli.net/2024/04/28/D4IK6tZiCesa2Nx.png)
...
>
> 这个笔记是从上面作者再次拷贝本地图片上传来的，感谢
>
> https://jimhackking.github.io/%E8%BF%90%E7%BB%B4/MySQL%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/#%E5%9B%BE%E5%BD%A2%E5%8C%96%E7%95%8C%E9%9D%A2%E5%B7%A5%E5%85%B7
